...
//
//	NOTE: This middleware should only be used when behind a reverse proxy
//	like nginx, HAProxy or Apache. Reverse proxies that don't (or are
...
/*
Original Implementation by: github.com/gorilla/handlers
*/
