...
func file_sample_v1_foo_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sample_v1_foo_api_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_sample_v1_foo_api_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_sample_v1_foo_api_proto_msgTypes[2].Exporter = func(v any, i int) any {
