...
func RegisterBarAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BarAPIServer) error {
	...
	mux.Handle("POST", pattern_BarAPI_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_BarAPI_Ping_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_BarAPI_Health_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_BarAPI_Health_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_BarAPI_Request_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_BarAPI_Request_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_BarAPI_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"bar", "ping"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BarAPI_Health_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"bar", "health"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BarAPI_Request_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"bar", "request"}, "", runtime.AssumeColonVerbOpt(true)))
)
